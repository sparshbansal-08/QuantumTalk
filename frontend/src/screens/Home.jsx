  ...
  return (
    <main className="home-container">
      <div className="text-center mb-4">
        ...
        <Title level={2} style={{ color: "#ff6347" }}>
          Welcome to QuantumTalk
        </Title>
        <Text style={{ color: "#4682b4" }} className="block mb-4">
          Collaborate and manage your projects effortlessly
        </Text>
      </div>
      <div className="projects flex flex-wrap gap-3 justify-center">
        ...
        {projects.map((project) => (
          ...
          >
            <Title level={4} style={{ color: "#4682b4" }}>
              {project.name}
            </Title>
            <Space>
              <UserOutlined />
